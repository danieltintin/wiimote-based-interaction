...
public class Frontend extends javax.swing.JFrame implements GestureListener,
    ...
    private void initComponents() {
        ...
        wiimotePanel1 = new src.other.WiimotePanel();
        graphPanel1 = new src.other.GraphPanel();
        ...
        infraredPanel1 = new src.other.InfraredPanel();
        rotationPanel = new javax.swing.JPanel();
        orientationPanel1 = new src.other.OrientationPanel();
    ...
    private src.other.GraphPanel graphPanel1;
    ...
    private src.other.InfraredPanel infraredPanel1;
    ...
    private src.other.OrientationPanel orientationPanel1;
    ...
    private src.other.WiimotePanel wiimotePanel1;
